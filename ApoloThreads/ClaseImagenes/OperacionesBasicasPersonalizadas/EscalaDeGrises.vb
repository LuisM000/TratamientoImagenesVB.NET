...
Public Class EscalaDeGrises
    ...
    Private Sub EscalaDeGrises_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        HScrollBar1.Value = 0
    ...
    Private Sub BackgroundWorker1_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        Principal.PictureBox1.Image = objetoTratamiento.EscalaGrises(bmpP, HScrollBar1.Value)
    End Sub
