Public Class Actualizar
    Public Function ComprobarVersion() As String()
        ...
        Try
            ...
            My.Computer.Network.DownloadFile("http://actualizarapolo.p.ht/Version.txt", rutaGuardar)
    ...
    Public Function DescargarActualizacion(ByVal SO_64 As Boolean) As String
        ...
        Try
            If SO_64 = True Then
                My.Computer.Network.DownloadFile("http://actualizarapolo.p.ht/Setupx64.exe", rutaGuardar, "u643642961", "luis000luis000", True, 500, False)
            Else
                My.Computer.Network.DownloadFile("http://actualizarapolo.p.ht/Setupx86.exe", rutaGuardar, "u643642961", "luis000luis000", True, 500, False)
            End If
            Return rutaGuardar
