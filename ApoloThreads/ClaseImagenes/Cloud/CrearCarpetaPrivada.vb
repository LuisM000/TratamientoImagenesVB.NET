...
Public Class CrearCarpetaPrivada
    ...
    Private Sub BackgroundWorker1_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        ...
        valor = objetoConexion.CrearCarpetaPrivada(UsernameTextBox.Text, PasswordTextBox.Text, EmailTextBox.Text)
    End Sub
    ...
    Private Sub BackgroundWorker1_RunWorkerCompleted(sender As Object, e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles BackgroundWorker1.RunWorkerCompleted
        ...
        If valor = True Then
            ...
            If checkCreden.Checked = True Then
                My.Settings.CloudUser = UsernameTextBox.Text
                My.Settings.CloudPass = PasswordTextBox.Text
                My.Settings.Save()
            End If
        End If
    End Sub
