...
Public Class BlancoYnegro
    ...
    Private Sub BlancoYnegro_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub BackgroundWorker1_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        Principal.PictureBox1.Image = objetoTratamiento.BlancoNegro(bmpP, HScrollBar1.Value)
    End Sub
